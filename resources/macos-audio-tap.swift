...
final class AudioTapCapture {
    ...
    private let ioQueue = DispatchQueue(label: "com.openmur.audio-tap")
    ...
    func start() throws {
        ...
        tapDescription.name = "openmur-audio-tap"
    ...
    private func createAggregateDevice(tapUID: String) throws {
        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "openMur Audio Tap",
            kAudioAggregateDeviceUIDKey: "com.openmur.audio-tap.\(UUID().uuidString)",
...
func makeError(
    ...
    return NSError(domain: "openMurAudioTap", code: Int(status ?? -1), userInfo: userInfo)
}
