...
const DEFAULT_DESKTOP_CALLBACK_URL = "https://openmur.com/auth/desktop-callback";
...
class GoogleCalendarOAuth {
  ...
  _getDesktopCallbackUrl() {
    return process.env.VITE_OPENMUR_OAUTH_CALLBACK_URL || DEFAULT_DESKTOP_CALLBACK_URL;
  }

  _getProtocol() {
    const channel = process.env.OPENMUR_CHANNEL || "production";
