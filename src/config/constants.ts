...
const DEFAULT_OPENAI_BASE = computeBaseUrl(
  [env.OPENMUR_OPENAI_BASE_URL as string | undefined, env.OPENAI_BASE_URL as string | undefined],
  "https://api.openai.com/v1"
);

const DEFAULT_TRANSCRIPTION_BASE = computeBaseUrl(
  [
    env.OPENMUR_TRANSCRIPTION_BASE_URL as string | undefined,
...
// openMur Cloud API
export const OPENMUR_API_URL = (env.VITE_OPENMUR_API_URL as string) || "";
