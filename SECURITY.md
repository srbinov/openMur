...
Use [GitHub's private vulnerability reporting](https://github.com/openMur/openmur/security/advisories/new)
to submit a report. You can also email security@openmur.com.
